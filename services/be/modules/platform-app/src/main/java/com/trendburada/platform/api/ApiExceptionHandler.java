...
public class ApiExceptionHandler {
    ...
    /**
     * Maps the customer/me service's deeper-than-bean-validation rejections (e.g. Feb 31
     * birthDate that passed the regex) to the SAME 400 + {field: message} shape that
     * {@link MethodArgumentNotValidException} produces above. Keeping one body shape lets
     * the FE's {@code extractFieldErrors} hook unpack both without a special case.
     */
